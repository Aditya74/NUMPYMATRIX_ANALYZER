...
def get_whole_data_summary(arr : np.ndarray):
    ...
    print(f"Addition of the whole data is { matrix_addition}")
    matrix_subtraction = np.subtract(arr,arr)
    print(f"subtraction of the whole data is {matrix_subtraction }")
    matrix_multiplication = np.multiply(arr,arr)
    print(f"multiplication of the whole data is {matrix_multiplication}")
    matrix_division = np.divide(arr,arr)
    print(f"division of the whole data is {matrix_division}")
